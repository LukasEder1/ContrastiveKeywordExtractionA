...
def build_sentence_freqs_ngram(sentence, n, symbols_to_remove):
    """
    in: sentence
...
def build_sentence_freqs_max_ngram(sentence, higher_ngram, lower_ngram = 1, symbols_to_remove=[","]):
    """
    in: sentence
    ...
    for n in range(lower_ngram, higher_ngram+1):
        freqs.update(build_sentence_freqs_ngram(sentence, n, symbols_to_remove))
